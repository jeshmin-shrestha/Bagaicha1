...
//	}
//
//	public UserModel getSpecificStudentInfo(String userName) {
//		if (isConnectionError) {
//			System.out.println("Connection Error!");
//			return null;
//		}
...
//
//				// Create and add StudentModel to the list
//				studentList.add(new UserModel(result.getInt("userName"), // Student ID
//						result.getString("first_name"), // First Name
//						result.getString("last_name"), // Last Name
//						result.getString("email"), // Email
//						result.getString("number") // Phone Number
...
//	}
//
//	public boolean updateStudent(UserModel student) {
//		if (isConnectionError)
//			return false;
//
