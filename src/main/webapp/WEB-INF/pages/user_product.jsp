...
body {
    ...
    line-height: 1.6;
        ...
        .product-card {
        background-color: #C3CDB2; /* Red background */
        border-radius: 15px;
        padding: 25px;
        margin: 30px 0;
...
.plant-detail img {
    ...
    height: 80px;
    object-fit: contain;
    filter: none; /* Remove the white filter since background is white */
}
...
@media (max-width: 768px) {
    ...
    /* Update heading color for red background */
    .product-card h2 {
        color: white;
        margin-bottom: 20px;
    } 
