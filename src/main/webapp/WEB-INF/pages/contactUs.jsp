...
<body>
	...
	<c:if test="${param.success == '1'}">
		<p class="success-message">Thank you! Your message has been
			received.</p>
	</c:if>
	<c:if test="${param.subscribed == '1'}">
	...
	<div class="contact-container">
		...
		<section class="form-section">
			...
			<!-- Newsletter Form -->
			<div class="contact-card">
				<h3 style="font-size: 1.7rem; margin-bottom: 10px;">🌿 Join Our
					Green Letter</h3>
				<p style="margin-bottom: 25px; color: #2c6e49; font-weight: 500;">
					One email. Once a month. Everything you need to grow better.</p>
				<form method="post"
					action="${pageContext.request.contextPath}/contact"
				...
				<p style="font-size: 0.8rem; margin-top: 15px; color: #333;">We
					hate spam. Unsubscribe anytime.</p>
			</div>
		</section>
		...
		<section class="contact-info">
			...
			<div class="info-item">
				<img src="resources/images/system/locationpin.png" class="info-icon">
