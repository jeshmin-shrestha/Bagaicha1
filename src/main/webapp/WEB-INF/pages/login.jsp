...
<body>
    ...
    <div class="right-panel">
       <!-- Login Form -->
		...
		<form id="login-form" class="auth-form" action="${pageContext.request.contextPath}/login" method="post" enctype="multipart/form-data">
...
<div class="no-account">
    <p style="text-align: center; color: #666; margin-top: 1rem;">
        ...
        <a href="${pageContext.request.contextPath}/register" style="color: #2e7d32;">Register here</a>
    </p>
</div>
			</div>
