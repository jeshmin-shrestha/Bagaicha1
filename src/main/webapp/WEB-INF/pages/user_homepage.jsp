...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/user_homepage.css" />
	...
	<div class="container">
		...
		<section class="reminders-section">
			...
			<div class="reminders-grid">
				...
				<div class="reminder-card">
					<div class="reminder-icon">
						<img src="resources/images/system/cart_icon.png"
							alt="Nutrition Icon">
					</div>
					<div class="reminder-content">
						...
						<c:forEach items="${plants}" var="plant" varStatus="loop">
							<div class="plant-card">
								<c:choose>
									...
									<c:otherwise>
										<img
											src="${pageContext.request.contextPath}/resources/images/system/default-plant.jpg"
											alt="${plant.plantName}" class="plant-image">
									</c:otherwise>
								</c:choose>
		...
		<section class="cta-section">
			...
			<div class="cta-cards">
				...
				<div class="cta-card">
					...
					<div class="cta-content">
						...
						<a href="${pageContext.request.contextPath}/about"
							class="see-more-btn">Learn More</a>
					</div>
				</div>
				...
				<div class="cta-card">
					<div class="cta-icon">
						<img src="resources/images/system/mailsub.png"
							alt="Newsletter Icon">
					</div>
					<div class="cta-content">
						...
						<a href="${pageContext.request.contextPath}/contact"
							" class="see-more-btn">Send us feedback</a>
					</div>
				</div>
			</div>
		</section>
